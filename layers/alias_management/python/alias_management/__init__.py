...
class AliasManagement(ElasticSearch):
    ...
    def create_alias(self, masterUUID, aliasUUID):
        ...
        if document:
            ...
            # Add is_master flag to masterUUID document
            self.update_document_by_UUID(masterUUID, {"is_master": True})
    ...
    def unalias(self, masterUUID, aliasUUID):
        ...
        # Find aliasUUID in metadata array
            metadata_array = [
                metadata for metadata in metadata_array if metadata["UUID"] == aliasUUID]
        ...
        # For each metadata
            ...
            # Remove is_master flag to masterUUID document
            self.update_document_by_UUID(masterUUID, {"is_master": False})
